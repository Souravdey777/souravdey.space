...
export default function WorkExperience() {
    return (
        <div id="workExperience">
            ...
            <br />
            <p>
                Worked in multiple Projects and Technologies while gaining Proficiency in HTML, CSS, JavaScript,
                React.js & React Native, Express.js Node.js.
                <br />
                <br />
                Proficient with concepts of Single Page Applications, Progressive Web Applications, Rest APIs, and
                Google Cloud.
                <br />
                <br />
                Created User Stories, developed highly impactful app both mobile and web with that also contributed to
                Product marketing strategies and UX designing
                <br />
                <br />
            ...
            >
                <span className="gradientText">INDIAN OIL CORPORATION LIMITED (IOCL)</span>
            </p>
            <div style={{ fontSize: '1rem' }}>
            ...
            <br />
            <p>
                Gained experience with Database Modeling, Understanding of SAP software, and Network Schema of IOCL.
                <br />
                <br />
                INVENTORY MANAGEMENT SYSTEM | JAVA (SWING), SQL
                <br />A System Software for Managing Inventory, Stocks, Sales, Purchase, and Reports
            </p>
            <p
                className="gradientText"
                style={{
            ...
            <br />
            <br />
            <p>Skill-building Experience in Java SE & Android while completing various assignments and projects.</p>
            <div
                style={{
                    marginTop: '3rem',
                    display: 'flex',
