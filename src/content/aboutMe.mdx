...
> <br/>
> - Enhancing and Revamping the product experience for recruiters from Test Creation to report generation.
> - Led the [**Certified Assessment**](https://www.hackerrank.com/features/certified-assessments/) product feature from inception to market-ready.
> - Contributed to the development of multiple initiatives to increase customer satisfaction and product growth.
> - Migrated multiple pages from **Backbone.js** to **React.js**.
> - Leading the Performance and user-centric development in web horizontal.
> <br/>
