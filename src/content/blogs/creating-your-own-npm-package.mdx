...
description: Create and deploy your first npm package with ease.
publishedDate: 2021/04/08
lastUpdatedDate: 2021/04/08
published: true
tags:
  - javascript
  - npm
image: https://cdn.hashnode.com/res/hashnode/image/upload/v1618253413643/77m7wj3hZ.jpeg?w=1600&h=840&fit=crop&crop=entropy&auto=compress,format&format=webp
views:
---
...
What you need to start is a simple Node.js installation and yes, that is it.
