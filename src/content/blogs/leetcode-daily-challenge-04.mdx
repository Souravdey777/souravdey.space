...
description: "4th July 2022 | 🗓 Daily LeetCode Challenge - #4"
...
2. Now, traverse from the left of the array to the right of the array and increase the count of the candies to be given based on the rating of the neighbor child. In this iteration, we are incrementing the candies count only based on the left neighbor.
