...
lastUpdatedDate: 2021/10/26
published: true
tags:
image:
---

![souravdey.space](/images/blogs/portfolio-website-development-part-2/screenshot.png)
...
<video width="100%" height="auto" controls autoplay>
  <source
    src="/images/blogs/portfolio-website-development-part-2/recorded.mp4"
    type="video/mp4"
  />
...
The website is a single-page website that has a scroll view.
On clicking on the top right menu items the page scrolls to that specific section.
